...
const API_KEY= "d12626af934dc74b0eb572913aa4a9bb";
...
const formatCurrentWeather =(data)=>{
    ...
    return{ lat, lon, temp, feels_like, temp_min, temp_max, humidity, name, country, sunrise, sunset, icon,details, speed, dt}
