...
function TemperatureAndDetails({weather :{details, temp, icon,temp_min, temp_max, sunrise, sunset,speed, feels_like, timezone, humidity}}) {
  return (
    <div>
        ...
        <img src={iconUrlFromCode(icon)} alt="img"
        className='w-20 '/>
